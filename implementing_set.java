public class Set<T> {
  private T arrayElement[]; //initialize empty array of type T
  int size = 0; //initialize size at 0, this will be used to add Elements.
  ...
  * no return value and the method is private
  */
...
/*
in incrementArray, this line seems really important:
(T[]) new Object[tempsize];
The type cast of an Object into an array is neat.
*/
